...
Dabei wurde ein Wert von \SI{2,23}{\volt} gemessen, obwohl ein Spannungsabfall von \SI{6}{\volt} erwartet worden war.
 Diese Abweichung bei der Messung des Spannungsabfalls lässt sich dadurch erklären, 
...
\begin{figure}
    ...
    \label{fig:6}
\end{figure}
Die Versorgungsspannung der Schaltung beträgt \qty{12}{\volt}. Als Eingangssignal wurde ein Sinussignal mit einer Amplitude von \SI{20}{\milli\volt} und einer Frequenz von \SI{1}{\kilo\hertz} gewählt. Der Arbeitspunkt des Ausgangssignals soll bei \qty{6}{\volt} liegen. Die Simulationsergebnisse zeigen ein sinusförmiges Ausgangssignal mit einer größeren Amplitude, siehe Abbildung \ref{fig:6}. Die Verstärkung der Schaltung beträgt $23,25$, siehe Berechnung \ref{eq:4}. 
\begin{equation}
