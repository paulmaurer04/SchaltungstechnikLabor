...
\begin{document}
%
\title{\includegraphics[width=5cm]{logo.jpg} \\ Schaltungstechnik: Ein Experimenteller Überblick}
...
\textit{In diesem Praktikum wurden in mehreren Laborterminen verschiedene Transistor- und OPV-Schaltungen aufgebaut, Messungen durchgeführt und die Ergebnisse diskutiert.}
\thispagestyle{empty}
%
%
\tableofcontents
...
%
%
\input{1.Laborversuch}
\input{2.Laborversuch}
\input{3.Laborversuch}
\input{4.Laborversuch}
